...
internal static class ConformanceProgram
{
    public static async Task<int> RunAsync(string[] args)
    {
        try
        {
            ...
            Run(fixtureRoot);
            Console.WriteLine($"PASS: search protocol revision 1 fixtures conform ({fixtureRoot})");
            return 0;
        }
    ...
    private static void Run(string fixtureRoot)
    {
        ...
        AssertCurrentFixtureSemantics(fixtureRoot);
        ...
        ProtocolBinding binding)
    {
        RequestEnvelopeV1 status = BusinessCodec.DecodeRequest(
            TrimTerminalNewline(ReadNonEmpty(Path.Combine(fixtureRoot, "requests/status-v1.json"))),
            binding);
        Require(
        ...
        string reindexWait = ReadFixtureText(
            fixtureRoot,
            "requests/reindex-wait-v1.json").Replace(
                "\"timeout_ms\":30000",
                "\"timeout_ms\":300000",
    ...
    private static void AssertCurrentFixtureSemantics(string fixtureRoot)
    {
        JsonObject references = ReadSuccessResponse(fixtureRoot, "responses/references-v1.json");
        ...
        JsonObject unanchored = ReadSuccessResponse(
            fixtureRoot,
            "responses/references-unanchored-document-v1.json");
        ...
        JsonObject semanticsStale = ReadSuccessResponse(
            fixtureRoot,
            "responses/status-semantics-stale-v1.json");
        ...
        JsonObject configurationStale = ReadSuccessResponse(
            fixtureRoot,
            "responses/status-configuration-stale-v1.json");
        ...
        JsonObject recoveryRequired = ReadSuccessResponse(
            fixtureRoot,
            "responses/status-recovery-required-v1.json");
        ...
        ResponseEnvelopeV1 statusResponse = BusinessCodec.DecodeResponse(
            TrimTerminalNewline(ReadNonEmpty(Path.Combine(fixtureRoot, "responses", "status-v1.json"))));
        ...
        Require(
            ...
            "Revision 1 status fixture does not advertise background reindex discovery.");
        IReadOnlyList<BackgroundReindexOperation> operations =
            statusResponse.ReadBackgroundReindexOperations();
        Require(operations.Count > 0, "Revision 1 status fixture has no discoverable background operation.");
        Require(
            ...
            "Revision 1 status fixture changed the canonical background operation order.");

        ResponseEnvelopeV1 failedStatusResponse = BusinessCodec.DecodeResponse(
            TrimTerminalNewline(ReadNonEmpty(
                Path.Combine(fixtureRoot, "responses", "status-process-failure-v1.json"))));
        ...
        ResponseEnvelopeV1 structuredError = BusinessCodec.DecodeResponse(
            TrimTerminalNewline(ReadNonEmpty(Path.Combine(fixtureRoot, "responses", "structured-error-v1.json"))));
    ...
    private static void AssertPublishedSchema(string fixtureRoot)
    {
        ...
        string path = Path.Combine(schemaRoot, "business-v1.schema.json");
    ...
    private static void AssertContractHardening(string fixtureRoot, ProtocolBinding binding)
    {
        ...
        string yamlObjectRequest = ReadFixtureText(fixtureRoot, "requests/references-yaml-object-v1.json");
    ...
    private static void AssertStatusPathBudget(string fixtureRoot)
    {
        ...
        JsonObject unavailableActive = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject staleCurrent = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject recoveryWithoutFailure = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject cleanWithFailure = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject retryingWithoutFailure = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject disabledTimerWithDeadline = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject failureWhileServing = ParseObjectNode(
            ReadFixtureText(fixtureRoot, "responses/status-process-failure-v1.json"));
    ...
    {
        JsonObject status = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject lost = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject duplicateOrigin = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject duplicateId = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject unsorted = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
        ...
        JsonObject tooMany = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/status-v1.json"));
    ...
    {
        JsonObject error = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/structured-error-v1.json"));
        ...
        string policy)
    {
        ...
        JsonObject missingSourceObject = ParseObjectNode(
            ReadFixtureText(fixtureRoot, "responses/references-v1.json"));
        ...
        JsonObject unanchoredWithLegacyFileId = ParseObjectNode(
            ReadFixtureText(fixtureRoot, "responses/references-unanchored-document-v1.json"));
        ...
        JsonObject diagnosticRoot = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/references-v1.json"));
    ...
    {
        JsonObject failedRoot = ParseObjectNode(ReadFixtureText(fixtureRoot, "responses/reindex-wait-v1.json"));
        RequestEnvelopeV1 request = BusinessCodec.DecodeRequest(
            Encoding.UTF8.GetBytes(ReadFixtureText(fixtureRoot, "requests/reindex-wait-v1.json")),
            binding);
