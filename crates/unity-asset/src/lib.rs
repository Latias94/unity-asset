...
pub use unity_asset_core::{
    ...
    BudgetedJsonError, BudgetedSourceBytes, BundleMemberId, ChangeSet, ChangeSetError,
    ContainmentKind, ContractError, DecompressionBudget, DecompressionUsage, Diagnostic,
    DiagnosticError, DiagnosticSeverity, DigestBuildError, DigestParseError, DigestV1,
    DigestV1Builder, DocumentFormat, FieldPath, FieldPathError, FieldPathSegment, IdentityRemap,
    ObjectAddress, ObjectId, ObjectKind, Result, RevisionedObjectHandle, SourceAlias,
    SourceFingerprint, SourceId, SourceKind, SourceLocator, SourceMemberId, TransactionId,
    UnityAssetError, UnityClass, UnityClassRegistry, UnityDocument, UnityValue, WorkspaceId,
    WorkspaceRevision, YamlAnchor, YamlDocumentSelector, constants::*,
};
