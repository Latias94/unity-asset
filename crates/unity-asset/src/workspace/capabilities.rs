...
mod tests {
    ...
    fn json_field_order_and_contract_versions_are_stable() {
        ...
        let expected = concat!(
            ...
            r#""streamed_resource_query":1,"prepare_report":1,"commit_report":1,"#,
            r#""recovery_locator":1,"recovery_discovery":1,"recovery_outcome":1,"#,
            r#""rollback_receipt":1,"bundle_container_query":1,"bundle_container_result":1,"#,
            r#""reference_graph_projection":1,"extraction_request":1,"extraction_plan":1,"#,
            r#""extraction_manifest":1,"#,
            r#""extraction_report":1,"yaml_split_report":1},"#,
