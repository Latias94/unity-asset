...
fn texture2d_converter_parses_streamdata_from_typetree() {
    ...
    let offset = u64::MAX - 16;
    stream_obj.insert("offset".to_string(), UnityValue::from(offset));
    ...
    let class = UnityClass::with_properties(
        ...
        indexmap::IndexMap::from([
            ...
            ("m_MipCount".to_string(), UnityValue::Integer(1)),
            ("m_ImageCount".to_string(), UnityValue::Integer(1)),
            ("m_TextureDimension".to_string(), UnityValue::Integer(2)),
            ("m_CompleteImageSize".to_string(), UnityValue::Integer(16)),
    ...
    assert_eq!(tex.stream_info.offset, offset);
