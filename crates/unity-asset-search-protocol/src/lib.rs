...
pub use model::{
    ...
    HighlightRangeV1, Location, MAX_ERROR_MESSAGE_BYTES, MAX_PORTABLE_PATH_BYTES,
    ...
    PortablePath, PortablePathError, RankingSignalsV1, ReferenceContext, ReferenceCoverage,
    ReferenceCursor, ReferenceDiagnosticCoverage, ReferenceDirection, ReferenceHit,
    ReferenceObject, ReferenceRequest, ReferenceSelector, ReferencesResponse,
