...
pub use model::{
    ...
    DaemonProcessComponent, DaemonProcessFailure, FilesystemReindexIntent, FilesystemReindexScope,
    FreshnessMaintenance, FuzzyWorkUsageV1, GenerationFailure, GenerationFreshness, GenerationIdV1,
    GenerationMaintenanceState, GenerationMaintenanceStatus, GenerationStamp, GenerationStatus,
    ...
    MatchExplanationV1, PortablePath, PortablePathError, RankingSignalsV1, ReconcileLifecycle,
    ReferenceContext, ReferenceCoverage, ReferenceCursor, ReferenceDiagnosticCoverage,
    ReferenceDirection, ReferenceHit, ReferenceObject, ReferenceRequest, ReferenceSelector,
    ReferencesResponse, ReindexAnalysisEvidence, ReindexDiskEstimate, ReindexDisposition,
    ReindexEvidence, ReindexReceipt, SEARCH_PROTOCOL_REVISION, SearchCapabilities,
    SearchDiagnosticV1, SearchHit, SearchResponse, ServingAvailability, StatusResponse,
    SuggestResponse, TermExplanationV1, TimerLifecycleState, TimerStatus, WatcherLifecycleState,
    WatcherStatus, WireProjectionError,
};
pub use operation::{
