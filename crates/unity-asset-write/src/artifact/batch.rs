...
use super::{
    ...
    ArtifactNameError, ArtifactPayload, ArtifactPayloadError, ArtifactReader, ArtifactSetFootprint,
    ArtifactSourceDependency, ArtifactStreamError, ArtifactStreamReceipt, ImageBuilder,
    LogicalArtifactName, PreparedArtifactFormat, StreamedResourceExtentInspection,
};
...
impl<'artifact, 'inspection> ArtifactBatch<'artifact, 'inspection> {
    ...
    fn prepare_inner(
        ...
        let (format, preaccounted_inspection_bytes) =
            PreparedArtifactFormat::inspect(expected, sealed.segmented(), self.inspection_budget)?;
