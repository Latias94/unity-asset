...
#[test]
fn can_parse_minimal_unityraw_v3_bundle_and_extract_file() {
    ...
    let compressed_size = uncompressed_size; // UnityRaw is uncompressed
    ...
    assert_eq!(parsed.header.signature, "UnityRaw");
