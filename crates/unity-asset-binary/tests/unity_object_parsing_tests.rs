...
fn test_unity_object_transform_detection() {
    ...
    let info = ObjectInfo::for_standalone_class(67890, 0, 4, 4).expect("valid class ID");
...
fn test_unity_object_describe() {
    ...
    // Test unnamed object
    let info2 = ObjectInfo::for_standalone_class(67890, 0, 4, 4).expect("valid class ID");
...
fn test_unity_object_with_complex_transform() {
    ...
    let info = ObjectInfo::for_standalone_class(44444, 0, 4, 4).expect("valid class ID");
...
fn test_wrong_class_id_parsing() {
    ...
    let info = ObjectInfo::for_standalone_class(99999, 0, 4, 28).expect("valid class ID");
